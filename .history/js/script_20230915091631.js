...
const init = () => {
  try {
    ...
    // console.war("Мы не на странице index.html...");
  }
  ...
  try {
    const validationForm = (form) => {
      ...
      .addField('#location', [
        { 
          rule: "required", 
          errorMessage: "Заполните название город" 
        },
      ])
      .addField('#email', [
        { 
    ...
    const formController = () => {
      ...
      form.addEventListener("submit", async (event) => {
        ...
        document.querySelector('.employer__error').textContent = 'Отправка, немного подождите...'
        ...
        document.querySelector('.employer__error').textContent = 'Произошла о...'
        console.error(error);
      }
      });
    };
    ...
    console.log("error", error);
    console.war("Мы не на странице employer.html...");
  }
};
